...
static constexpr auto s_tag = "[ScoutingTimingAnalyzer]";

TEST_CASE("Standard checks of ScoutingTimingAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("ScoutingTimingAnalyzer"
